...
class invariant_set_domain_factoryt : public ai_domain_factory_baset
{
public:
  invariant_set_domain_factoryt(invariant_propagationt &_ip) : ip(_ip)
  {
  }
  ...
  {
    return util_make_unique<invariant_set_domaint>(
      static_cast<const invariant_set_domaint &>(s));
  }
